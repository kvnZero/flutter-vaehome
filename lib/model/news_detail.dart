...
@JsonSerializable()
class NewsDetail extends Object {
  ...
  @JsonKey(name: 'favoriteFlag')
  bool favoriteFlag;

  @JsonKey(name: 'userDingFlag')
  bool userDingFlag;

  NewsDetail(this.id,this.categoryId,this.flag,this.title,this.content,this.poster,this.source,this.sourceUrl,this.pushTime,this.photo,this.addUserId,this.addTime,this.status,this.modifyUserId,this.modifyTime,this.viewCount,this.dingCount,this.reviewCount,this.shareCount,this.transgressCount,this.lastReviewTime,this.isReview,this.transgressStatus,this.transgressUniCount,this.categoryInfo,this.photoList,this.addUserInfo,this.addTimeDesc,this.pushTimeDesc,this.favoriteFlag,this.userDingFlag,);

  factory NewsDetail.fromJson(Map<String, dynamic> srcJson) => _$NewsDetailFromJson(srcJson);
